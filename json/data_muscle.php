...
{   
    ...
    $exercises[] = array('exercise_id'=> $exercise_id, 'exercise_title'=> $exercise_title, 'exercise_reps'=> $exercise_reps,'exercise_sets'=> $exercise_sets, 'exercise_rest'=> $exercise_rest, 'exercise_level'=> $exercise_level, 'exercise_equipment'=> $exercise_equipment, 'exercise_image'=> $exercise_image,'exercise_video'=> $exercise_video, 'exercise_tips'=> $exercise_tips, 'exercise_instructions'=> $exercise_instructions, 'level_title'=> $level_title, 'equipment_title'=> $equipment_title, 'bodypart_title'=> $bodypart_title , 'exercises_bodyparts_bodypart_id'=> $exercises_bodyparts_bodypart_id);
