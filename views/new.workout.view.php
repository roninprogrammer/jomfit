...
<h3 class="title-pages">Workout</h3>
...
<label class="control-label">Status</label>
   ...
   <div class="row">
                        <div class="col-sm-1">
                             <div class="radio radio-success">
                                <input type="radio" name="workout_status" id="radio5" value="1" checked="">
                                <label for="radio5">
                                    Publish
                                </label>
                            </div>
   ...
   <input name="workout_image" class="input-file" type="file" required="">
