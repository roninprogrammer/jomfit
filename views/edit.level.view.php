...
<h3 class="title-pages">Edit Level<span class="label label-default" style="font-size: 11px; float: right; right: 10px;">ID <?php echo $level['level_id']; ?></span></h3>
...
<div class="form-group" style="padding: 0px 10px 0px 0px;">
   ...
   <label class="control-label">Image: <a href="<?php echo SITE_URL ?>/images/<?php echo $level['level_image']; ?>" data-lightbox="image-1"><?php echo $level['level_image']; ?></a></label>
   <input name="level_image" class="input-file" type="file">
