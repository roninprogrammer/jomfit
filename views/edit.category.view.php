...
<h3 class="title-pages">Edit Category Diet<span class="label label-default" style="font-size: 11px; float: right; right: 10px;">ID <?php echo $category['category_id']; ?></span></h3>
...
<div class="form-group" style="padding: 0px 10px 0px 0px;">
   ...
   <label class="control-label">Image: <a href="<?php echo SITE_URL ?>/images/<?php echo $category['category_image']; ?>" data-lightbox="image-1"><?php echo $category['category_image']; ?></a></label>
   <input name="category_image" class="input-file" type="file">
